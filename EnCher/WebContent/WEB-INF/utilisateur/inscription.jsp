		...
		<div class="row col-lg-6 m-auto">
			...
			<div class="form-floating col-lg-6 mb-4">
				<input type="text" class="form-control" id="nom" name="nom"
					placeholder=" " required> <label for="nom"
					class="px-3 text-muted">Nom</label>
			</div>

			<div class="form-floating col-lg-6 mb-4">
				<input type="text" class="form-control" id="prenom" name="prenom"
					placeholder=" " required> <label for="prenom"
					class="px-3 text-muted">Prénom</label>
			</div>

			<div class="form-floating col-lg-6 mb-4">
				<input type="date" class="form-control" id="date_naissance"
					name="date_naissance" placeholder=" " required> <label
			...
			<div class="form-floating col-lg-6 mb-4">
				<input type="text" class="form-control" id="rue" name="rue"
					placeholder=" " required> <label for="rue"
			...
			<div class="form-floating col-lg-6 mb-4">
				<input type="text" class="form-control" id="ville" name="ville"
					placeholder=" " required> <label for="ville"
			...
			<div class="form-floating col-lg-6 mb-4">
				<input type="password" class="form-control" id="password"
					...
					for="password" class="px-3 text-muted">Mot de passe</label>
			</div>
			...
			<div class="col-6 mx-auto d-flex">
				<button type="submit" class="w-100 btn btn-lg btn-primary mb-1 mx-3">S'inscrire</button>
